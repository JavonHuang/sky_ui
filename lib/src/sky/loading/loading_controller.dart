...
class SkyLoadingController {
  ...
  Widget initLoading(BuildContext context, Widget? child) => TekLoadingWrapper(
  ...
  void setCurrentOverlayEntry(TekLoadingOverlayEntry? overlayEntry) => _currentOverlayEntry = overlayEntry;
