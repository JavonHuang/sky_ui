...
class _TabCellItemState extends State<TabCellItem> with HoverActionMix {
  ...
  Widget build(BuildContext context) {
    ...
    Widget child = widget.builder?.call(widget.menu, meta) ?? TolyUITabCell(menu: widget.menu, meta: meta);

    MouseCursor cursor = widget.menu.enable ? SystemMouseCursors.click : SystemMouseCursors.forbidden;
